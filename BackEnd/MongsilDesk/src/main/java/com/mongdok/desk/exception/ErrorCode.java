...
public enum ErrorCode {
	...
	FAIL_GET_BOARD(3000, "FAIL_GET_BOARD", "방명록 불러오기 실패"),
	FAIL_CREATE_BOARD(3100, "FAIL_CREATE_BOARD", "방명록 생성 실패"),
	FAIL_UPDATE_BOARD(3200, "FAIL_UPDATE_BOARD", "방명록 업데이트 실패"),
	FAIL_DELETE_BOARD(3300, "FAIL_DELETE_BOARD", "방명록 삭제 실패"),
	FAIL_READ_BOARD(3400, "FAIL_READ_BOARD", "방명록 읽음처리실패"),
	FAIL_GET_ALLBOARD(3500, "FAIL_GET_ALLBOARD", "모든 방명록 불러오기 실패"),
